  ...
  return (
    <div className='w-full h-screen bg-zinc-900 p-20 flex gap-5'>
        <div className='w-1/2 h-full flex justify-between flex-col '>
            ...
            <h1 className='text-[5vw] font-semibold leading-none -mb-5'>EYE-</h1>
            <h1 className='text-[5vw]  font-semibold leading-none -mb-5'>OPENING</h1>
            </div>
        ...
        <div className='w-1/2'>
        <div className="heading">
            <h1 className='text-[5vw] font-semibold leading-none -mb-5'>PRESENTATIONS
            </h1>
            <div className="dets mt-10">
                <a className='block text-xl font-light' href="#">gopal</a>
                <a className='block text-xl font-light' href="#">anuj</a>
                <a className='block text-xl font-light' href="#">pradhu</a>
                <a className='block text-xl font-light' href="#">sourabh</a>
                <a className='block text-xl font-light'  href="#">naveen</a>
            </div>
